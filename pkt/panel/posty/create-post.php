        ...
        <article class="col-12 m-auto  mt-5 mb-5">
            <div class='container'>
                <div class='container m-auto text-center'>
                    <form method="post" action="create-post-database.php">
                        <h4 class='mt-5 pt-1 text-center'>Tworzenie nowego postu</h4>
                        <div class="card-body">
                            <div class='input-group mb-4'>
                                <div class='input-group-prepend'>
                                    <span class='input-group-text font-weight-bold' id='titleAd'>Tytuł postu</span>
                                </div>
                                <input type='text' class='form-control' id='title' name='title' placeholder='Wprowadź tytuł postu' aria-label='Wprowadź tytuł postu' aria-describedby='titleAd'>
                            </div>
                        
                            <textarea id="content" name="content" placeholder="Treść postu">
